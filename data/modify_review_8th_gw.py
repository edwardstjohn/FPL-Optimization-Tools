...
def add_decayed_last_four_gws_to_eight():
    ...
    data[col_8] = data[col_8] + (data[col_9] * decay_9) + (data[col_10] * decay_10) + (data[col_11] * decay_11) + (data[col_12] * decay_12)

    # Dropping the now redundant columns
    data.drop(columns=[col_9,c9mins,col_10,c10mins,col_11,c11mins,col_12,c12mins], inplace=True)
